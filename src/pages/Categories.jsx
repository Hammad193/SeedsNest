  ...
  return (
    <div className="bg-[#f8faf8] min-h-screen">
      ...
      <CategoryHero
        ...
        description="Discover premium gardening essentials, seeds, plants, garden care products and much more for your perfect green space."
        route="Home / Categories"
      />

      {/* CATEGORY SECTION */}
      <section className="py-14 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-10">
