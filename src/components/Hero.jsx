    ...
    <section className="relative w-full overflow-hidden bg-white pt-32 pb-20">
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <Link to="/seeds">
                <button className="group bg-green-600 hover:bg-green-700 text-white px-11.5 py-4 rounded-2xl font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105 shadow-lg cursor-pointer">
                  Shop Seeds
